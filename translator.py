...
#添加header
myComputer = {'User-Agent':'Mozilla/5.0 (Windows NT 6.1) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.101 Safari/537.36'}
while True:
    ...
    require = urllib.request.Request(url,data,myComputer)
